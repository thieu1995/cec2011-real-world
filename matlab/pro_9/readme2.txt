...
To determine the bounds of the varaibles, "domain_range.m" can be used. This file should also be copied in the same directory. The way to calculate "GD_max" is shown in that file. 
NOTE: GD_min = 0 
